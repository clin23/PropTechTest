...
import { TenantDetailPanel } from './TenantDetail';
import { TenantListPanel } from './TenantList';
import type {
  TenantListFilters,
  TenantListItem,
  TenantListQuery,
      ...
      {open ? (
        <div className="absolute right-0 z-20 mt-2 w-72 rounded-lg border border-border/60 bg-surface/95 p-4 text-sm shadow-lg">
          ...
          <p className="mt-1 text-muted-foreground">
            ...
            <kbd className="ml-1 rounded border px-1">Ctrl</kbd>+<kbd className="rounded border px-1">K</kbd> to jump to search.
